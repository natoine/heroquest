<script lang="ts">
	...
	// ── Change username ────────────────────────────────────────
	// svelte-ignore state_referenced_locally — snapshot intentionnel pour le champ
...
<svelte:head>
	<title>{data.user.username} — {$t('account.title')} — HeroQuest</title>
</svelte:head>
...
<div class="container account-page">
	...
	<div class="welcome-banner">
		<span class="welcome-torch" aria-hidden="true">🔥</span>
		<div>
	...
	<div class="settings-list">
		...
		<div class="settings-section settings-section--danger" class:open={openSection === 'delete'}>
			...
			>
				<span class="section-icon" aria-hidden="true">💀</span>
				<span class="section-title">{$t('account.deleteAccount')}</span>
...
<style>
	...
	.form-input:focus {
		border-color: var(--color-border-glow);
		box-shadow: 0 0 0 2px rgba(200, 125, 47, 0.2);
	}
